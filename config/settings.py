...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'inventario-equipos-hkmd.onrender.com',
]
...
# ============================================
# EMAIL CONFIGURATION (local = console, prod = SMTP)
# ============================================
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'sistema@inventario.local')

# ============================================
# CLOUDINARY - Configuracion para evidencias
# ============================================
import cloudinary
